...
export default class ResultPage extends React.Component {
    ...
    render() {
        let body = (this.state.suggestions.length == 0) ?
            this.state.products.map(function (p, i) {
                return <ProductListing
                    ...
                    asin={p.asin} />
            }) : <div className="error-container"> <img src="static/img/404.png" className="four-oh-four-img"></img><span>Did you mean to type: {this.state.suggestions}</span></div>;
        return (
            <div>
