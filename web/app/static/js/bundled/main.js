...
},{"./lib/ReactPropTypesSecret":44,"_process":42,"fbjs/lib/invariant":35,"fbjs/lib/warning":39}],44:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/ExecutionEnvironment":26,"fbjs/lib/containsNode":29,"fbjs/lib/emptyFunction":30,"fbjs/lib/emptyObject":31,"fbjs/lib/getActiveElement":32,"fbjs/lib/shallowEqual":38,"object-assign":41,"react":50}],47:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":42,"fbjs/lib/emptyFunction":30,"fbjs/lib/emptyObject":31,"fbjs/lib/invariant":35,"fbjs/lib/warning":39,"object-assign":41,"prop-types/checkPropTypes":43}],49:[function(require,module,exports){
/** @license React v16.3.1
...
},{"fbjs/lib/emptyFunction":30,"fbjs/lib/emptyObject":31,"object-assign":41}],50:[function(require,module,exports){
(function (process){
'use strict';
...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function addButtonOnClick() {
      ...
      if (new_d != "" && this.state.descriptors.indexOf(new_d) == -1) _axios2.default.get("/suggestions?query=" + this.refs.New_search.value + "," + this.state.descriptors.join(",")).then(function (res) {
...
},{"axios":1,"react":50}],52:[function(require,module,exports){
'use strict';
